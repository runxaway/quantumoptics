                ...
                <div className={styles.Block}>
                    ...
                    <div className={styles.BottomBlock}>
                        ...
                        <div className={styles.ContactText}>
                            ...
                            Приоритетным направлением деятельности компании являются научные исследования и разработки, направленные на создание твердотельных лазеров нового поколения с диодной накачкой и современных оптико-электронных систем для жестких условий эксплуатации.
                            </p>
                            <br/>
                            <p>
                            Высокая квалификация сотрудников компании позволяет в сжатые сроки выполнять полный цикл работ от НИР и ОКР до производства и адаптации оборудования у конкретного потребителя, сократить стоимость создания нового продукта.
                            Компания использует современную элементную базу, новые материалы и технологии.
                            </p>
                            <br/>
                            <p>
                            Постоянно ведется поиск новых принципов построения лазерных систем, совершенствуются конструкторские решения, внедряются новые технологические процессы.
