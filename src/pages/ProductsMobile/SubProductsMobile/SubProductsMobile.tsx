...
import styles from './SubProductsMobile.module.scss'

import { SubProductCardMobile } from "../../../components/SubProductCardMobile/SubProductCardMobile";
...
const SubProductsMobile = (): JSX.Element => {
    window.scrollTo(0, 0);
...
export default SubProductsMobile;